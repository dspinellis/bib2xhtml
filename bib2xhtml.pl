...
sub utf_ent {
	...
	s/\\c(\001\d+)\{c\1\}/\006ç\006/gs;
	s/\\c(\001\d+)\{D\1\}/\006Ḑ\006/gs;
	s/\\c(\001\d+)\{d\1\}/\006ḑ\006/gs;
	s/\\c(\001\d+)\{E\1\}/\006Ȩ\006/gs;
	s/\\c(\001\d+)\{e\1\}/\006ȩ\006/gs;
	s/\\c(\001\d+)\{G\1\}/\006Ģ\006/gs;
	s/\\c(\001\d+)\{g\1\}/\006ģ\006/gs;
	s/\\c(\001\d+)\{H\1\}/\006Ḩ\006/gs;
	s/\\c(\001\d+)\{h\1\}/\006ḩ\006/gs;
	...
	s/\\c(\001\d+)\{n\1\}/\006ņ\006/gs;
	s/\\c(\001\d+)\{R\1\}/\006Ŗ\006/gs;
	s/\\c(\001\d+)\{r\1\}/\006ŗ\006/gs;
	s/\\c(\001\d+)\{S\1\}/\006Ş\006/gs;
	s/\\c(\001\d+)\{s\1\}/\006ş\006/gs;
	s/\\c(\001\d+)\{T\1\}/\006Ţ\006/gs;
	s/\\c(\001\d+)\{t\1\}/\006ţ\006/gs;
	s/\\c(\001\d+)\{X\1\}/\006X̧\006/gs;
	s/\\c(\001\d+)\{x\1\}/\006x̧\006/gs;
	...
	# ogonek \k{x}
	s/\\k(\001\d+)\{A\1\}/\006Ą\006/gs;
	s/\\k(\001\d+)\{a\1\}/\006ą\006/gs;
	s/\\k(\001\d+)\{E\1\}/\006Ę\006/gs;
	s/\\k(\001\d+)\{e\1\}/\006ę\006/gs;
	s/\\k(\001\d+)\{I\1\}/\006Į\006/gs;
	s/\\k(\001\d+)\{i\1\}/\006į\006/gs;
	s/\\k(\001\d+)\{O\1\}/\006Ǫ\006/gs;
	s/\\k(\001\d+)\{o\1\}/\006ǫ\006/gs;
	s/\\k(\001\d+)\{U\1\}/\006Ų\006/gs;
	s/\\k(\001\d+)\{u\1\}/\006ų\006/gs;
